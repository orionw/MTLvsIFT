"""Tests for transferprediction.utils."""
...
from transferprediction import utils


class ConfigureLoggingTestCase(unittest.TestCase):
    """Test transferprediction.utils.configure_logging."""
...
class FileLoggingTestCase(unittest.TestCase):
    """Test transferprediction.utils.FileLogging."""
